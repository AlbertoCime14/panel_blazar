    ...
    <div class="container">
                ...
                <div class="page-title-box">
                    <div class="float-right">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Ordenes fraudulentas</li>
                        </ol>
                    </div>
                    <h4 class="page-title">Ordenes fraudulentas</h4>
                </div>
                <!--end page-title-box-->
            </div>
            <!--end col-->
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <button type="button" class="btn btn-primary btn-sm px-4 mt-0 mb-3" onclick="location.href='<?php echo base_url('ordenes/add'); ?>'"><i class="mdi mdi-plus-circle-outline mr-2"></i>Añadir nuevo orden</button>
