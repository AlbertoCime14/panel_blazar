        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="page-title-box">
                    ...
                    <h4 class="page-title">Configuracion general</h4>
                </div>
                <!--end page-title-box-->
            </div>
            <!--end col-->
                    ...
                    <div class="card-body">
                        ...
                        <form class="form-horizontal form-material mb-0">
                            <div class="form-group row">
                                <div class="col-md-6">
                                    <input type="text" placeholder="Nombre del sitio" class="form-control" name="First_Name" id="First_Name">
                                </div>
                                <div class="col-md-6">
                                    <input type="text" placeholder="Base url" class="form-control" name="Last_Name" id="Last_Name">
                                </div>
                            </div>
