        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="page-title-box">
                    ...
                    <h4 class="page-title">Configuracion seguridad</h4>
                </div>
                <!--end page-title-box-->
            </div>
            <!--end col-->
                    ...
                    <div class="card-body">
                        ...
                        <form class="form-horizontal form-material mb-0">
                            <div class="form-group row">
                                <div class="col-md-6">
                                    <input type="text" placeholder="bloquear ip" class="form-control" name="First_Name" id="First_Name">
                                </div>
                                <div class="col-md-6">
                                    <input type="text" placeholder="Cambiar servidor" class="form-control" name="Last_Name" id="Last_Name">
                                </div>
                            </div>

                            <div class="form-group row">
                                <div class="col-md-3">
                                    <input type="text" placeholder="Descripción footer" class="form-control" name="Admit_Date" id="Admit_Date">
                                </div>
                                <div class="col-md-3">
                                    <input type="text" placeholder="Payment gateway" class="form-control" name="Department" id="Department">
                                </div>
                                <div class="col-md-3">
                                ...
                                <div class="col-md-3">
                                    <input type="text" placeholder="theme" class="form-control" name="Age" id="">
                                </div>
                            </div>
