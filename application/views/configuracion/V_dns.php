                ...
                <div class="page-title-box">
                    <div class="float-right">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Configurar dns</li>
                        </ol>
                    </div>
                    <h4 class="page-title">Configurar dns</h4>
                </div>
                <!--end page-title-box-->
            </div>
            <!--end col-->
                    ...
                    <div class="card-body">
                        ...
                        <form class="form-horizontal form-material mb-0">
                            <div class="form-group row">
                                <div class="col-md-6">
                                    <input type="text" placeholder="Correo electronico" class="form-control" name="First_Name" id="First_Name">
                                </div>
                                <div class="col-md-6">
                                    <input type="text" placeholder="Puerto" class="form-control" name="Last_Name" id="Last_Name">
                                </div>
                            </div>

                            <div class="form-group row">
                                <div class="col-md-6">
                                    <input type="text" placeholder="Servidor" class="form-control" name="Admit_Date" id="Admit_Date">
                                </div>
                                <div class="col-md-6">
                                    <input type="text" placeholder="Correo" class="form-control" name="Department" id="Department">
                                </div>

                            </div>

                            <div class="form-group">
                                <textarea rows="5" placeholder="Anotaciones" class="form-control"></textarea>
