                    ...
                    <div class="page-title-box">
                        <div class="float-right">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">Ad-ons</li>
                            </ol>
                        </div>
                        <h4 class="page-title">Add ons</h4>
                    </div>
                    <!--end page-title-box-->
                </div>
                <!--end col-->
                    ...
                    <div class="card">
                        <div class="card-body text-center">
                            <div class="text-right">
                                <a href="#" data-toggle="modal" data-animation="bounce" data-target=".bs-example-modal-lg"><i class="las la-pen text-info font-18"></i></a>
                                <a href="#"><i class="las la-trash-alt text-danger font-18"></i></a>
                            </div>
                            <img src="<?php echo base_url(); ?>/recursos/assets/images/users/dr-4.jpg" alt="user" height="100" class="rounded-circle mt-n3">
                            <h5 class="mb-1 client-name">Ejemplo 1</h5>
                            <p class="text-muted mb-1">"Lorem ipsum dolor sit amet,</p>
                            <p class="text-center font-14">"Lorem ipsum dolor sit amet</p>
                            <button type="button" class="btn btn-sm btn-outline-primary" onclick="location.href='<?php echo base_url('add_ons/detail'); ?>'">Añadir</button>
                        </div>
                        <!--end card-body-->
                    </div>
                    <!--end card-->
