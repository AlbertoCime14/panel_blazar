                        ...
                        <div class="table-responsive shopping-cart">
                            <table class="table mb-0">
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            <img src="<?php echo base_url(); ?>/recursos/assets/images/products/img-1.png" alt="" height="40">
                                    ...
                                    <tr>
                                        <td>
                                            <img src="<?php echo base_url(); ?>/recursos/assets/images/products/img-4.png" alt="" height="40">
                                    ...
                                    <tr>
                                        <td>
                                            <img src="<?php echo base_url(); ?>/recursos/assets/images/products/img-7.png" alt="" height="40">
                                    ...
                                    <div class="card border mb-1 shadow-none">
                                        <div class="card-header custom-accordion" id="headingOne">
                                            <a href="" class="text-dark d-flex justify-content-between" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                                ...
                                                <img src="<?php echo base_url(); ?>/recursos/assets/images/cards/card-2.png" alt="" height="30">
                                            </a>
                                        </div>
                                    ...
                                    <div class="card mb-1 border shadow-none">
                                        <div class="card-header" id="headingTwo">
                                            <a href="" class="text-dark d-flex justify-content-between collapsed" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                                                ...
                                                <img src="<?php echo base_url(); ?>/recursos/assets/images/cards/paypal.png" alt="" height="30">
                                            </a>
                                        </div>
