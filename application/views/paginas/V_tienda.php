                        ...
                        <div class="col-md-3">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <!--end ribbon-->
                                    <img src="<?php echo base_url(); ?>/recursos/assets/images/products/img-7.png" alt="" class="d-block mx-auto my-4" height="170">
                                    ...
                                    <a class="btn btn-soft-primary btn-block" href="<?php echo base_url('product/detail'); ?>">Add To Cart</a>
                                </div>
                                <!--end card-body-->
                            </div>
                            <!--end card-->
                        ...
                        <div class="col-md-3">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <!--end ribbon-->
                                    <img src="<?php echo base_url(); ?>/recursos/assets/images/products/img-6.png" alt="" class="d-block mx-auto my-4" height="170">
                                    <div class="d-flex justify-content-between align-items-center my-4">
                                        <div>
                                            <p class="text-muted mb-2">Interior Product</p>
                                            <a href="#" class="header-title">Unique Black Watch</a>
                        ...
                        <div class="col-md-3">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <!--end ribbon-->
                                    <img src="<?php echo base_url(); ?>/recursos/assets/images/products/img-5.png" alt="" class="d-block mx-auto my-4" height="170">
                                    <div class="d-flex justify-content-between align-items-center my-4">
                                        <div>
                                            <p class="text-muted mb-2">Interior Product</p>
                                            <a href="#" class="header-title">Unique Black Watch</a>
                        ...
                        <div class="col-md-3">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <!--end ribbon-->
                                    <img src="<?php echo base_url(); ?>/recursos/assets/images/products/img-4.png" alt="" class="d-block mx-auto my-4" height="170">
                                    <div class="d-flex justify-content-between align-items-center my-4">
                                        <div>
                                            <p class="text-muted mb-2">Interior Product</p>
                                            <a href="#" class="header-title">Unique Black Watch</a>
                        ...
                        <div class="col-md-3">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <!--end ribbon-->
                                    <img src="<?php echo base_url(); ?>/recursos/assets/images/products/img-3.png" alt="" class="d-block mx-auto my-4" height="170">
                                    <div class="d-flex justify-content-between align-items-center my-4">
                                        <div>
                                            <p class="text-muted mb-2">Interior Product</p>
                                            <a href="#" class="header-title">Unique Black Watch</a>
                        ...
                        <div class="col-md-3">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <!--end ribbon-->
                                    <img src="<?php echo base_url(); ?>/recursos/assets/images/products/img-1.png" alt="" class="d-block mx-auto my-4" height="170">
                                    <div class="d-flex justify-content-between align-items-center my-4">
                                        <div>
                                            <p class="text-muted mb-2">Interior Product</p>
                                            <a href="#" class="header-title">Unique Black Watch</a>
