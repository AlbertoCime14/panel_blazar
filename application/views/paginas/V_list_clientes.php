    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="page-title-box">
                    ...
                    <h4 class="page-title">Todos los clientes</h4>
                </div>
                <!--end page-title-box-->
            </div>
            <!--end col-->
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <button type="button" class="btn btn-primary btn-sm px-4 mt-0 mb-3" onclick="location.href='<?php echo base_url('add/client'); ?>'"><i class="mdi mdi-plus-circle-outline mr-2"></i>Añadir nuevo cliente</button>
