                    ...
                    <div class="page-title-box">
                        <div class="float-right">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">Notificar clientes</li>
                            </ol>
                        </div>
                        <h4 class="page-title">Notificar clientes</h4>
                    </div>
                    <!--end page-title-box-->
                </div>
                <!--end col-->
            ...
            <div class="row">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="media mb-3">
                                <img src="<?php echo base_url(); ?>/recursos/assets/images/users/user-4.jpg" class="mr-3 thumb-xl align-self-center rounded-circle" alt="...">
                            ...
                            <div>
                                <button type="button" class="btn btn-sm btn-soft-secondary">Enviar notificacion</button>
                                <button type="button" class="btn btn-sm btn-soft-primary">Enviar Email</button>
                            </div>
                        </div>
                        <!--end card-body-->
                    </div>
                ...
                <div class="col-lg-4">
                    <div class="card">
                        <div class="card-body">
                            <div class="media mb-3">
                                <img src="<?php echo base_url(); ?>/recursos/assets/images/users/user-1.png" class="mr-3 thumb-xl align-self-center rounded-circle" alt="...">
                                <div class="media-body align-self-center">
                                    <h4 class="mt-0 mb-1">Donald Gardner</h4>
                                    <p class="text-muted mb-0 font-12">Dealer, Washington </p>
                                    <ul class="list-inline mb-0 align-self-center">
                ...
                <div class="col-lg-4">
                    <div class="card">
                        <div class="card-body">
                            <div class="media mb-3">
                                <img src="<?php echo base_url(); ?>/recursos/assets/images/users/user-5.jpg" class="mr-3 thumb-xl align-self-center rounded-circle" alt="...">
                                <div class="media-body align-self-center">
                                    <h4 class="mt-0 mb-1">Donald Gardner</h4>
                                    <p class="text-muted mb-0 font-12">Dealer, Washington </p>
                                    <ul class="list-inline mb-0 align-self-center">
            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="card">
                        <div class="card-body">
                            <div class="media mb-3">
                                <img src="<?php echo base_url(); ?>/recursos/assets/images/users/user-5.png" class="mr-3 thumb-xl align-self-center rounded-circle" alt="...">
                                <div class="media-body align-self-center">
                                    <h4 class="mt-0 mb-1">Donald Gardner</h4>
                                    <p class="text-muted mb-0 font-12">Dealer, Washington </p>
                                    <ul class="list-inline mb-0 align-self-center">
                ...
                <div class="col-lg-4">
                    <div class="card">
                        <div class="card-body">
                            <div class="media mb-3">
                                <img src="<?php echo base_url(); ?>/recursos/assets/images/users/user-8.jpg" class="mr-3 thumb-xl align-self-center rounded-circle" alt="...">
                                <div class="media-body align-self-center">
                                    <h4 class="mt-0 mb-1">Donald Gardner</h4>
                                    <p class="text-muted mb-0 font-12">Dealer, Washington </p>
                                    <ul class="list-inline mb-0 align-self-center">
                ...
                <div class="col-lg-4">
                    <div class="card">
                        <div class="card-body">
                            <div class="media mb-3">
                                <img src="<?php echo base_url(); ?>/recursos/assets/images/users/user-10.jpg" class="mr-3 thumb-xl align-self-center rounded-circle" alt="...">
                                <div class="media-body align-self-center">
                                    <h4 class="mt-0 mb-1">Donald Gardner</h4>
                                    <p class="text-muted mb-0 font-12">Dealer, Washington </p>
                                    <ul class="list-inline mb-0 align-self-center">
