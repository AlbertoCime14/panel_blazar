        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="page-title-box">
                    ...
                    <h4 class="page-title">Detalle producto</h4>
                </div>
                <!--end page-title-box-->
            </div>
            <!--end col-->
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-lg-6 align-self-center">
                                <img src="<?php echo base_url(); ?>/recursos/assets/images/products/img-1.png" alt="" class=" mx-auto  d-block" height="300">
                            </div>
                            <!--end col-->
                            <div class="col-lg-6 align-self-center">
                                <div class="single-pro-detail">
                                    ...
                                    <h3 class="pro-title">Metrica Air Max Shoes</h3>
                                    ...
                                    <div class="quantity mt-3 ">
                                        ...
                                        <a href="<?php echo base_url('product/checkout'); ?>" class="btn btn-primary btn-sm text-white px-4 d-inline-block"><i class="mdi mdi-cart mr-2"></i>Compra ahora</a>
                                    </div>
                                </div>
                            </div>
                            <!--end col-->
            ...
            <div class="col-md-8">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="text-muted mb-3 font-14">There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable. If you are going
                            to use a passage.
                        </p>
                    </div>
                    <!--end card-body-->
                    ...
                    <div class="col-md-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <!--end ribbon-->
                                <img src="<?php echo base_url(); ?>/recursos/assets/images/products/img-5.png" alt="" class="d-block mx-auto my-4" height="150">
                                <div class="d-flex justify-content-between align-items-center my-4">
                                    <div>
                                        <p class="text-muted mb-2">Fashion & Life Style</p>
                                        <a href="#" class="header-title">Unique Black Bag</a>
                                    </div>
                                    <div>
                    ...
                    <div class="col-md-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <!--end ribbon-->
                                <img src="<?php echo base_url(); ?>/recursos/assets/images/products/img-4.png" alt="" class="d-block mx-auto my-4" height="150">
                                <div class="d-flex justify-content-between align-items-center my-4">
                                    <div>
                                        <p class="text-muted mb-2">Look & Life Style</p>
                                        <a href="#" class="header-title">Unique Black Watch</a>
                                    </div>
                                    <div>
                                        <h4 class="text-dark mt-0 mb-2">$999.00 <small class="text-muted font-14"><del>$1999.00</del></small></h4>
                                        <ul class="list-inline mb-0 product-review align-self-center">
                                            <li class="list-inline-item"><i class="la la-star text-warning font-16"></i></li>
                                            <li class="list-inline-item"><i class="la la-star text-warning font-16 ml-n2"></i></li>
                                            <li class="list-inline-item"><i class="la la-star text-warning font-16 ml-n2"></i></li>
